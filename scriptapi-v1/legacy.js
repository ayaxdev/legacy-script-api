var script = registerScript({
    name: "§4LEGACY SCRIPT - DO §lNOT§r§4 CONTACT LIQUIDBOUNCE STAFF FOR HELP, MESSAGE \"ayyyx\" ON DISCORD INSTEAD",
    version: "1.0.0",
    authors: ["§4LEGACY SCRIPT - DO NOT CONTACT LIQUIDBOUNCE STAFF FOR HELP, MESSAGE \"ayyyx\" ON DISCORD INSTEAD"]
});
...
script.on("load", function () {
    try {
        script.setScriptName(scriptName + " - §4LEGACY SCRIPT - DO §lNOT§r§4 CONTACT LIQUIDBOUNCE STAFF ABOUT ERRORS, MESSAGE \"ayyyax\" ON DISCORD INSTEAD");
        script.setScriptVersion(scriptVersion.toString());
        script.setScriptAuthors([scriptAuthor, "§4LEGACY SCRIPT - DO §lNOT§r§4 CONTACT LIQUIDBOUNCE STAFF ABOUT ERRORS, MESSAGE \"ayyyax\" ON DISCORD INSTEAD"]);
    } catch (err) {
    }
...
var _AdaptedModule = function (module) {
    ...
    this.unregister = function () {
        moduleManager.unregisterModule(this.module);
    }
...
var _ModuleManager = function () {
    ...
    this.getModule = function (name) {
        return new _AdaptedModule(moduleManager.getModule(name));
    }

    this.getModules = function () {
        var modules = new this.ArrayList(moduleManager.getModules());
        var adaptedModules = [];
...
var moduleManagerV1API = new _ModuleManager();
var commandManagerV1API = new _CommandManager();
var creativeTabsV1API = new _CreativeTabs();
var itemV1API = new _Item();
var valueV1API = new _Value();
var chatV1API = Chat;
